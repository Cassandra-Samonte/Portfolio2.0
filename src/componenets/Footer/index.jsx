  ...
  return (
    <footer className="footer flex justify-between items-center p-4 px-20">
      ...
      <ul className="px-10">
        ...
        <li>
          <a href="https://drive.google.com/file/d/1-HCXr551YEBE0iKzCnaqQN10YrnPqF_G/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">Resume</a>
        </li>
      </ul>
    </footer>
  );
